...
export default {
    editor: {
        ...
        customStylePropertiesOrder: [
            'customMenu',
            {
                label: 'Toolbar',
                isCollapsible: true,
                properties: ['menuColor', 'menuHoverColor', 'menuBgColor', 'menuHoverBgColor', 'menuEdgeFade', 'menuPadding'],
            },
            {
                label: 'Modal',
                isCollapsible: true,
    ...
    properties: {
        ...
        menuPadding: {
            ...
            propertyHelp: {
                tooltip: 'Horizontal padding of the scrollable toolbar.',
            },
            /* wwEditor:end */
        },
        modalBgColor: {
